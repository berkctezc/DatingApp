...
### Account Controller with a Register Endpoint (BE)
...
### Creating a User DTO and returning the token (BE)
...
### Adding authentication middleware (BE)
